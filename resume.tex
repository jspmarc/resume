...
\project
    ...
    {https://github.com/jspmarc/IF4051-Tubes}
    {
        ...
        Sensor emits a message every second which processed and saved, then predicted on using
        machine learning.

        Tech stack: Python, PySpark, Vue.js, Platform.io, InfluxDB, Telegraf, Redis, MQTT, Kafka
    }
